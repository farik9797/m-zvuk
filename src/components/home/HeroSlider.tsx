...
const SLIDES = [
  ...
  },
  {
    ...
    desc: 'Озвучивание ресторанов, спортивных залов, конференц-комнат и ТРЦ «под ключ». Выезд специалиста в Гродно и областях.',
  ...
  },
  {
    ...
    desc: 'Вокальные микрофоны SM7B, BETA 58A и цифровая радиосистема SLX-D уже на складе ООО «Арт-Медиа Трейд» в Гродно.',
