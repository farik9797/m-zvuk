...
const ADVANTAGES = [
  ...
  },
  {
    ...
    desc: 'Авторизованная диагностика и ремонт звукового оборудования в Гродно с оригинальными запчастями.'
  },
  {
    icon: <Truck className="w-8 h-8 text-orange-500" />,
    title: 'Доставка по Беларуси за 24ч',
    desc: 'Оперативная доставка курьерской службой DPD/Autolight по Гродно, областным и районным центрам РБ.'
  },
  {
