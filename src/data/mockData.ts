...
export const MOCK_FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Да, абсолютно на все продаваемое оборудование предоставляется официальная гарантия производителя сроком от 12 до 36 месяцев. В Гродно работает собственный сервисный центр ООО «Арт-Медиа Трейд».',
    category: 'warranty'
  },
  {
    id: 'faq-4',
